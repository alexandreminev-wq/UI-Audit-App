...
// ─────────────────────────────────────────────────────────────
// Component Signature Helpers (7.4.1 → 7.8: Moved to shared/componentKey.ts)
// ─────────────────────────────────────────────────────────────
//
// buildComponentSignature(), hashSignature(), and inferRoleFromTag()
// are now imported from apps/extension/src/ui/shared/componentKey.ts
// to ensure Viewer and Sidepanel use identical component key logic.
