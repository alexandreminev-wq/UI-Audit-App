...
interface LegacySessionsViewerProps {
    // (Props interface will be populated when integrating this component)
}
...
export function LegacySessionsViewer(props: LegacySessionsViewerProps) {
